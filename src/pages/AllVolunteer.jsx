            ...
            <div className="flex justify-around items-center flex-col">
                <form onSubmit={handleSearch} className="max-w-md mx-auto">
                    ...
                    <div className="relative">
                        ...
                        <input name="search" type="text" id="search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
                ...
                <div>
                    <div className="dropdown dropdown-bottom">
                        ...
                        <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                            <li onClick={() => handleAll('All')}><a>Item 1</a></li>
