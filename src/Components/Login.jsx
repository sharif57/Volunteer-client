...
const Login = () => {
    ...
    return (
        <div className="flex justify-center items-center">
            <img className="size-[700px] hidden sm:block" src="https://i.ibb.co/Nrjpq9T/Pngtree-cyber-security-concept-in-3d-7601742.png" alt="" />
            <div className="w-full font-Roboto max-w-md mx-auto p-4 rounded-sm  mt-4  sm:p-8  dark:text-gray-800">
